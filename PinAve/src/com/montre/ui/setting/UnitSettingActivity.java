...
public class UnitSettingActivity extends BasicUI {
	...
	public void initViews() {
		...
		int checkedMap = Setting.getUnit();
		if (checkedMap == Setting.UNIT_KM) {
			mapGroup.check(R.id.radio0);
		} else if (checkedMap == Setting.UNIT_MILE) {
	...
	private void onUpdate(){
		...
		if (checkedRadioButton == R.id.radio0) {
			Setting.setUnit(Setting.UNIT_KM);
		} else if (checkedRadioButton == R.id.radio1) {
			Setting.setUnit(Setting.UNIT_MILE);
		}
