...
#define kStreamBufferSize 1024000
...
-(CFHTTPMessageRef)generateBasicMessageRequestWithParams:(NSDictionary *)params {
    ...
    if (params != nil) {
        ...
        CFURLRef urlRef = CFURLCreateWithString(kCFAllocatorSystemDefault, (__bridge CFStringRef)url, NULL);
        
        CFHTTPMessageRef requestMsg = CFHTTPMessageCreateRequest(kCFAllocatorSystemDefault, (__bridge CFStringRef)method, urlRef, kCFHTTPVersion1_1);
...
-(void)setValue:(NSString *)value forHTTPHeaderField:(NSString *)header {
    ...
    CFHTTPMessageSetHeaderFieldValue(requestMessage, (__bridge CFStringRef)header, (__bridge CFStringRef)value);
...
-(void)startRequest {
    ...
    CFHTTPMessageSetBody(requestMessage, (__bridge CFDataRef)requestData);
...
-(void)requestFinished {
    ...
    NSData *data = [NSData dataWithData:(__bridge NSData *)streamResponseData];
