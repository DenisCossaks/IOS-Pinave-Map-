...
@property (nonatomic,unsafe_unretained) id queue;
@property (nonatomic,unsafe_unretained) id uploadProgressDelegate;
@property (nonatomic,unsafe_unretained) id downloadProgressDelegate;
