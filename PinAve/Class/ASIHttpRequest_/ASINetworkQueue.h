...
@property (nonatomic,unsafe_unretained,setter=setUploadProgressDelegate:) id uploadProgressDelegate;
@property (nonatomic,unsafe_unretained,setter=setDownloadProgressDelegate:) id downloadProgressDelegate;
